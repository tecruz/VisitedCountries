...
package com.example.visitedcountries.ui
...
import com.example.visitedcountries.navigation.VisitedCountriesNavHost
import com.example.visitedcountries.navigation.VisitedCountriesScreen

@Composable
fun VisitedCountriesMain(composeNavigator: AppComposeNavigator<VisitedCountriesScreen>) {
  VisitedCountriesTheme {
    ...
    VisitedCountriesNavHost(navHostController = navHostController)
  }
}
