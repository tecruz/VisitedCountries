...
interface CountryDao {
  ...
  suspend fun insertCountryList(countryList: List<CountryEntity>)

  @Query("SELECT * FROM CountryEntity")
  suspend fun getCountryList(): List<CountryEntity>

  @Query("SELECT * FROM CountryEntity WHERE name = :countryName")
  fun getCountryByName(countryName: String): CountryEntity

  @Update
  fun saveVisitedCountry(countryEntity: CountryEntity)
}
