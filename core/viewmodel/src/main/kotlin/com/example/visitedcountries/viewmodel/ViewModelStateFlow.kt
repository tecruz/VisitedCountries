...
package com.example.visitedcountries.viewmodel
...
class ViewModelStateFlow<T>(private val key: ViewModelKey, value: T) : MutableStateFlow<T> {
  ...
  @RestrictedApi
  override suspend fun emit(value: T) = throw IllegalAccessError("Use `emitValue` function instead of this")
  ...
  @RestrictedApi
  override fun tryEmit(value: T): Boolean = throw IllegalAccessError("Use `tryEmitValue` function instead of this")
